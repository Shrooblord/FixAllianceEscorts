...
meta =
{
    ...
    name = "FixAllianceEscorts",

    -- Title of your mod that will be displayed to players
    title = "Fix: Alliance Escorts",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Bugfixes Alliance craft not showing up as valid Escorts in the Operations UI for the Galaxy Map.",
